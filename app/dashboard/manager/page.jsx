...
function buildPrintHtml(app) {
  ...
  const request = {
    ...
    frontWidth: escapeHtml(payload?.front_width_mt ? `${payload.front_width_mt} mt` : '—'),
          ...
          <div class="content" style="padding-top:4px;">
            ...
            <div class="grid2">
              ${[
                ...
                ['Front Width', request.frontWidth],
...
const DUMMY_APPLICATIONS = [
  ...
  },
  {
    ...
    payload: {
      ...
      fuel_company_name: 'HPCL-Mittal Energy',
      land_type: 'Owned',
      rear_depth_mt: '52.00',
      front_width_mt: '28.00',
      lhs_depth_mt: '35.00',
      rhs_depth_mt: '35.00',
      khasra_no: '88/7',
      road_type: 'City Road',
